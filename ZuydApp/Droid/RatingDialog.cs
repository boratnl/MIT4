...
namespace ZuydApp.Droid
{
	...
	public class RatingDialog : DialogFragment
	{
		...
		private List<ZuydApp.VakClass> _alleVakken;
		public Context context;

		public RatingDialog(int position)
		{
			this._selecteditem = position;
			_alleVakken = ZuydApp.MijnVakkenAdapter.getMijnVakken();
		}
		...
		public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			...
			_tvTitel.Text = _alleVakken [_selecteditem].Naam;
			_rbRating.Rating = _alleVakken [_selecteditem].Id;
